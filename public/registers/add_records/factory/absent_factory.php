    ...
    <div class="h-screen flex justify-center items-center w-[85%] ml-[15%]">
        <div class="w-2xl text-center p-6 bg-white rounded-xl shadow-lg">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                <a href="f_absent_extra.php" class="bg-teal-500 text-white py-12 px-10 rounded-lg text-xl shadow-md transform transition-all duration-300 hover:scale-105 hover:shadow-xl font-semibold">Extra Transport</a>
                <a href="f_absent_petty.php" class="bg-[oklch(60.6%_0.25_292.717)] text-white py-12 px-10 rounded-lg text-xl shadow-md transform transition-all duration-300 hover:scale-105 hover:shadow-xl font-semibold">Petty Cash</a>
            </div>
