<?php
// adjustment_staff.php (Staff Payment Reduction Management)
...
if (isset($_POST['delete_id'])) {
    ...
    header("Location: adjustment_staff.php?month={$selected_month}&year={$selected_year}");
    exit();
}
...
$reduction_sql = "
    ...
    WHERE MONTH(r.date) = ? AND YEAR(r.date) = ? AND rt.purpose = 'staff'
...
$page_title = "Staff Payment Reduction Management";
$table_headers = [
    "Date",
    "Route",
    "Supplier",
...
<body class="bg-gray-50 text-gray-800 min-h-screen">
    ...
    <div class="flex gap-4"> 
        <?php if ($is_logged_in): ?>
            ...
            <a href="add_reduction.php" class="hover:text-yellow-600">Add Reduction</a>
        <?php endif; ?>
    </div>
</div>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3
         mt-1">
            ...
            <div class="w-full sm:w-auto">
                <form method="get" action="adjustment_staff.php" class="flex flex-wrap gap-2 items-center">
                        ...
                        <?php foreach ($reduction_records as $data): ?>
                            <tr class="hover:bg-blue-50 transition-colors duration-150 ease-in-out">
                                ...
                                <td class="py-3 px-6 whitespace-nowrap text-center flex gap-2">
                                    ...
                                    <form method="post" action="adjustment_staff.php" onsubmit="return confirm('Are you sure you want to delete this reduction record (ID: <?php echo htmlspecialchars($data['id']); ?>)?');">
    ...
    <div id="editModal" class="fixed inset-0 bg-gray-900 bg-opacity-75 z-50 flex items-center justify-center hidden">
        <div class="bg-white p-8 rounded-xl shadow-2xl w-full max-w-lg mx-4 transform transition-all duration-300">
            ...
            <form method="post" action="adjustment_staff.php?month=<?php echo $selected_month; ?>&year=<?php echo $selected_year; ?>" class="grid grid-cols-1 gap-4">
