...
<body class="bg-gray-100 text-gray-800">
    ...
    <a href="../Staff transport vehicle register.php" class="text-md font-bold tracking-wide bg-gradient-to-r from-yellow-200 via-yellow-400 to-yellow-200 bg-clip-text text-transparent">
    ...
    <span class="text-sm font-bold text-white uppercase tracking-wider px-1 py-1 rounded-full">
        ...
        <div class="flex items-center gap-4 text-sm font-medium"> 
            ...
            <a href="add_reduction.php" class="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md shadow-md transition transform hover:scale-105">Add Reduction</a>
