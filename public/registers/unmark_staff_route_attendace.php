<?php
// unmark_staff_route_attendace.php
            ...
            <form method="GET" class="flex flex-wrap items-center gap-4">
                ...
                <div class="relative">
                    ...
                    <select id="shift" name="shift" 
                        onchange="this.form.submit()"
                        class="pl-10 pr-8 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm bg-gray-50 text-gray-900 cursor-pointer hover:bg-white transition">
