    ...
    <div class="h-screen flex justify-center items-center w-[85%] ml-[15%]">
        <div class="w-xl text-center p-6 bg-white rounded-xl shadow-lg">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 ">
                ...
                <a href="non_paid/own_vehicle.php" class="bg-green-500 text-white py-12 px-10 rounded-lg text-xl font-semibold shadow-md transform transition-all duration-300 hover:scale-105 hover:shadow-xl">Own Vehicles</a>
