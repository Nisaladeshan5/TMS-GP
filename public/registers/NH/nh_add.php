...
<div class="w-[85%] ml-[15%] flex justify-center p-3 mt-6">
    <div class="container max-w-2xl bg-white shadow-lg rounded-lg p-8 mt-2">
        ...
        <p class="text-sm text-gray-600 mb-6">
            Enter trip details. Date and Time can be adjusted if needed.
        </p>
        ...
        <form method="POST" action="" id="addTripForm" class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-6 bg-indigo-50 p-4 rounded-md border border-indigo-100 mt-4">
                
                <div>
                    <label for="trip_date" class="block text-xs font-bold text-gray-500 uppercase mb-1">Date</label>
                    <input type="date" id="trip_date" name="trip_date" required 
                           value="<?php echo date('Y-m-d'); ?>"
                           class="block w-full rounded-md border-gray-300 shadow-sm p-2 text-gray-800 font-medium focus:ring-indigo-500 focus:border-indigo-500">
                </div>

                <div>
                    <label for="trip_time" class="block text-xs font-bold text-gray-500 uppercase mb-1">Start Time</label>
                    <input type="time" id="trip_time" name="trip_time" required 
                           value=""
                           class="block w-full rounded-md border-gray-300 shadow-sm p-2 text-indigo-600 font-bold text-lg focus:ring-indigo-500 focus:border-indigo-500">
                </div>
            </div>
