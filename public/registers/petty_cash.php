...
<div class="bg-gray-800 text-white p-2 flex justify-between items-center shadow-lg w-[85%] ml-[15%]">
    ...
    <div class="flex gap-4">
        <a href="add_records/add_petty_cash.php" class="hover:text-yellow-600">Add Record</a>
    </div>
</div>

<div class="container" style="width: 80%; margin-left: 18%; margin-right: 2.5%; display: flex; flex-direction: column; align-items: center;">
    <p class="text-[48px] font-bold text-gray-800 mt-2">Petty Cash Details</p>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td class='border px-4 py-2'>
                                <a href='edit_petty_cash.php?id={$row['id']}' class='text-blue-500 hover:text-blue-700 font-bold'>Edit</a>
                            </td>";
                        echo "</tr>";
                    }
                } else {
