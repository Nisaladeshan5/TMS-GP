...
$routes = [];
// NOTE: Filter for Factory Routes (____F%)
...
if ($filterRouteCode) {
    ...
    // NOTE: Using factory_transport_vehicle_register
...
<head>
    <meta charset="UTF-8">
    <title>Factory Route Attendance</title>
...
<body class="bg-gray-100 font-sans text-gray-800">
    ...
    <main class="w-[85%] ml-[15%] p-6">
        ...
        <div class="bg-white p-4 rounded-xl shadow-md border border-gray-200 mb-6 flex flex-col md:flex-row justify-between items-center">
            
            <div class="mb-4 md:mb-0">
                <h2 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
                    <i class="far fa-calendar-check text-indigo-600"></i>
                    Factory Route Attendance
                </h2>
            ...
            <form method="POST" class="flex flex-wrap items-center gap-3">
                ...
                <a href="all_f_routes_report_excel.php?month_year=<?php echo htmlspecialchars($filterDate); ?>&route_code=<?php echo htmlspecialchars($filterRouteCode ?? ''); ?>" 
                    target="_blank" 
                ...
                <a href="all_f_routes_report_pdf.php?month_year=<?php echo htmlspecialchars($filterDate); ?>&route_code=<?php echo htmlspecialchars($filterRouteCode ?? ''); ?>" 
                    target="_blank" 
                    class="bg-emerald-600 text-white px-4 py-2 rounded-lg shadow hover:bg-emerald-700 transition font-medium text-sm flex items-center gap-2">
