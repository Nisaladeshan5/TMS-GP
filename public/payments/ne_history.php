...
<div class="bg-gradient-to-r from-gray-900 to-indigo-900 text-white h-16 flex justify-between items-center shadow-lg w-[85%] ml-[15%] px-6 sticky top-0 z-40 border-b border-gray-700">
    ...
    <div class="flex items-center gap-4 text-sm font-medium">
        ...
        <form method="get" action="ne_history.php" class="flex items-center gap-2">
            <div class="relative">
        ...
        <a href="download_ne_history_excel.php?month=<?php echo $selected_month; ?>&year=<?php echo $selected_year; ?>" 
        ...
        <a href="night_emergency_payment.php" class="text-gray-300 hover:text-white transition flex items-center gap-2 text-xs uppercase tracking-wide font-bold">
            Current Payments
        </a>
                    ...
                    <thead class="text-white uppercase text-xs tracking-wider">
                        <tr>
                            <?php foreach ($table_headers as $index => $header): 
                                $align = ($index >= 3) ? 'text-right' : 'text-left';
                            ?>
                        ...
                        <?php if (!empty($history_data)): ?>
                            <?php foreach ($history_data as $data): ?>
                                <tr class="hover:bg-indigo-50 transition duration-150 group">
                                    ...
                                    <td class="py-3 px-6 whitespace-nowrap text-left text-gray-800">
                                        <?php echo htmlspecialchars($data['supplier_name'] ?? 'N/A'); ?>
                                    </td>
