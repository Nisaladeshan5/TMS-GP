<?php
// nh_history.php (Night Heldup Monthly Payments History)
...
$dates_sql = "SELECT DISTINCT year, month FROM monthly_payments_nh ORDER BY year DESC, month DESC";
...
// --- 4. TEMPLATE SETUP ---
$page_title = "Night Heldup Payments History";

// Table Headers (Date column removed)
$table_headers = [
    "Op Code (Vehicle No)", 
    "Total Distance (km)",      
    "Monthly Payment (LKR)" 
...
<div class="bg-gradient-to-r from-gray-900 to-indigo-900 text-white h-16 flex justify-between items-center shadow-lg w-[85%] ml-[15%] px-6 sticky top-0 z-40 border-b border-gray-700">
    ...
    <div class="flex items-center gap-4 text-sm font-medium">
        ...
        <form method="get" action="nh_history.php" class="flex items-center gap-2">
            <div class="relative">
        ...
        <a href="download_nh_history_excel.php?month=<?php echo $selected_month; ?>&year=<?php echo $selected_year; ?>" 
        ...
        <a href="nh_payments.php" class="text-gray-300 hover:text-white transition flex items-center gap-2 text-xs uppercase tracking-wide font-bold">
            Current Payments
        </a>
