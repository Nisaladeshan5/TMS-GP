<?php
// download_nh_history_excel.php
// Exports Night Heldup Monthly Payments History to Excel (Without Date Column)
...
$reportTitle = "Night Heldup Monthly Payments History - " . $monthName . " " . $year;
...
// --- EXCEL HEADERS ---
$filename = "Night_Heldup_Payments_" . $year . "_" . str_pad($month, 2, '0', STR_PAD_LEFT) . ".xls";
...
// 1. YELLOW TITLE HEADER ROW (Colspan 3)
echo '<tr>';
