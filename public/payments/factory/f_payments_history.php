<?php
// f_payments_history.php (Factory Monthly Payments History)
...
$dates_sql = "
    ...
    WHERE SUBSTRING(route_code, 5, 1) = 'F' 
...
<div class="bg-gradient-to-r from-gray-900 to-indigo-900 text-white h-16 flex justify-between items-center shadow-lg w-[85%] ml-[15%] px-6 sticky top-0 z-40 border-b border-gray-700">
    ...
    <div class="flex items-center gap-4 text-sm font-medium">
        ...
        <form method="get" action="f_payments_history.php" class="flex items-center gap-2">
            <div class="relative">
        ...
        <a href="download_f_history_excel.php?month=<?php echo $selected_month; ?>&year=<?php echo $selected_year; ?>" 
        ...
        <a href="factory_route_payments.php" class="text-gray-300 hover:text-white transition flex items-center gap-2 text-xs uppercase tracking-wide font-bold">
            Current Payments
        </a>
