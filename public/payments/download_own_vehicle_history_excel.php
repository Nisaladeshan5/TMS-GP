<?php
// download_own_vehicle_history_excel.php
// Exports Own Vehicle (Fuel Allowance) Monthly Payments History to Excel
...
// --- EXCEL HEADERS ---
$filename = "Fuel_Allowance_Payments_" . $year . "_" . str_pad($month, 2, '0', STR_PAD_LEFT) . ".xls";
...
echo '<th style="background-color:#4F81BD; width: 250px;">Employee (Vehicle No)</th>';
echo '<th style="background-color:#4F81BD; width: 150px;">Attendance Days</th>';
