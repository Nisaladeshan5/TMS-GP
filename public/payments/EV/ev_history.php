<?php
// ev_history.php (Extra Vehicle Monthly Payments History - Dynamic Filters)
    ...
    <main class="w-[85%] ml-[15%] p-3 mt-[2%]"> 
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3">
            ...
            <div class="w-full sm:w-auto">
                <form method="get" action="ev_history.php" class="flex flex-wrap gap-2 items-center">
                ...
                <thead>
                    <tr class="bg-blue-600 text-white text-sm font-bold tracking-wider uppercase">
                        <?php foreach ($table_headers as $header): ?>
                            <th class="py-3 px-6 <?php echo $header['align']; ?> border-b border-blue-500">
                        ...
                        <?php foreach ($history_data as $data): ?>
                            <tr class="hover:bg-blue-50 transition-colors duration-150 ease-in-out">
                                ...
                                <td class="py-3 px-6 whitespace-nowrap text-center">
                                    <a href="download_ev_history_pdf.php?code=<?php echo urlencode($data['code']); ?>&month=<?php echo $data['month']; ?>&year=<?php echo $data['year']; ?>" 
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="<?php echo count($table_headers); ?>" class="py-12 text-center text-gray-500 text-base font-medium">
                                No payment history data available for <span class="font-bold"><?php echo date('F Y', mktime(0, 0, 0, $selected_month, 10, $selected_year)); ?></span>.
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
